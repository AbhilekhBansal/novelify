                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr id="cart-product-{{$list->id}}">
                            ...
                            <td>
                                <a href="javascript:void(0)" onclick="deleteCartProduct('{{$list->id}}','0','{{$list->price}}')"><button class="remove-btn"><i class="fa-solid fa-xmark"></i></button></a>
                            </td>
                        </tr> 
                        @endforeach
                        <tr>
